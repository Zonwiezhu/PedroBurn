...
const textToType = "Burning PEDRO tokens creates a deflationary mechanism that benefits all holders. By reducing the total supply, each remaining token becomes more scarce and valuable. Our burning portal makes it easy to participate, simply connect your wallet and choose how many PEDRO tokens you'd like to burn for the community's benefit. Together we can strengthen the PEDRO ecosystem.";
  return (
    <>
      <Head>
        <title>PEDRO×BURN</title>
        <meta name="description" content="BURN PEDRO TOKENS FOR THE CULTURE" />
      </Head>
      ...
      >
        ...
        <section className="relative flex items-center justify-center h-screen text-center z-10">
          ...
          >
            ...
            >
              PEDRO × <span className="text-white font-mono bg-clip-text bg-gradient-to-r">BURN</span>
            </motion.h1>
            <motion.p 
        ...
        <section className="relative pt-64 pb-10 px-6 max-w-4xl mx-auto z-10">
          ...
          >
            <h2 className="text-3xl md:text-5xl text-center font-bold tracking-tighter mb-12">
              <span className="text-white bg-clip-text bg-gradient-to-r">BURNING PEDRO</span>
            </h2>
